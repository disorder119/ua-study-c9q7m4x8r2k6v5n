...
if(typeof document!=='undefined'&&typeof document.write==='function'){
  ['alphabet-app-v4-style.js','alphabet-app-v4-a.js','alphabet-app-v4-b.js','alphabet-app-v4-c.js','alphabet-app-v4-d.js','alphabet-app-v4-completion.js','alphabet-app-v4-init.js'].forEach(src=>document.write('<script src="./'+src+'"><\/script>'));
}else{
