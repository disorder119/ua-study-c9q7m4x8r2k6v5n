/* Ukrainischkurs für Joel · Laufzeit-Selbsttest v8 */
(() => {
  ...
  try{
    ...
    ok(!!s.activeProduction,'Aktive Produktion fehlt');ok(Number(s.activeProduction.version)>=2,'Aktive Produktion ist nicht auf v2');ok(!!s.a1CanDo,'A1-Can-do-Abschluss fehlt');ok(Number(s.a1CanDo.version)>=2,'Can-do ist nicht auf v2');
