/* Ukrainischkurs für Joel · Laufzeit-Selbsttest v12 */
(() => {
  ...
  try{
    ...
    ok(window.UKRAINIAN_COURSE_LOADER?.version===23,'Loader ist nicht auf v23');ok(window.UKRAINIAN_COURSE_LOADER?.evalFree===true,'Loader meldet keinen eval-freien Modus');ok(window.UKRAINIAN_COURSE_LOADER?.mode==='classic-script','Loader nutzt nicht den klassischen Skriptmodus');
