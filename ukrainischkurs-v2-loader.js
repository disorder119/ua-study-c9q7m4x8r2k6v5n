(async()=>{
  ...
  try{
    ...
    const modules=[
      ...
      ['./ukrainischkurs-learning-state-guard.js?v=1','Lernstatus- und Tagespfad-Härtung'],
    ...
    await loadScript('./ukrainischkurs-guided-start.js?v=1','Geführter bildlicher Alphabet-Start');
  }catch(error){
    window.UKRAINIAN_COURSE_LOADER.version=Number(VERSION);
