'use strict';
/* Alphabet Lab V6 core bundle · generated deterministically */
...
globalThis.AlphabetCoreV2=Object.freeze({
  VERSION:v6Available?6:3,APP_VERSION:v6Available?V6_APP_VERSION:'5.0.0',SCHEMA_VERSION:exportSchema,DAY,HOUR,MIN,ALPHABET,LEARN_ORDER,FAKE_FRIENDS,LATIN_TRAPS,HARD,VOWELS,CONSONANTS,SPECIAL,DATA,SOUND_GROUPS,CONTRASTS,CORE_SKILLS,SKILLS:exportSkills,KIND_SKILL,SKILL_LABELS:exportSkillLabels,INTERVALS,
  ...
  letterReady:letterReadyV4,letterStatus:letterStatusV4,learningState,problemFlag,writtenProductionReady:v5Available?writtenProductionReady:()=>false,audioWrittenProductionReady:v5Available?audioWrittenProductionReady:()=>false,productionNeed:v5Available?productionNeed:()=>-999,productionDifficulty:v5Available?productionDifficulty:()=>0,productionFamiliesFor:v5Available?productionFamiliesFor:()=>[],productionGate:v5Available?productionGate:()=>({done:false}),productionCoverageSummary:v6Available?productionCoverageSummaryV6:()=>({byFamily:{},totalLetters:0}),
