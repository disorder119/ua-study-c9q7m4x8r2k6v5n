...
const nativeRows=(native.match(/'[^']+':\['LL-Q8798 \(ukr\)-Tohaomg-/g)||[]).length;
assert(nativeRows>=20,`Zu wenige native Lingua-Libre-Referenzen (${nativeRows})`);
...
console.log('VALIDIERUNG OK: Syntax, Loader, Offline-Cache, Alphabet, Aussprache-Härtung und native Audioquellen geprüft.');
