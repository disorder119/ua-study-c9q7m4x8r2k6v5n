...
(()=>{
  ...
  const EXAMPLE={
    'А':['мама','Mama'],'Б':['банк','Bank'],'В':['вода','Wasser'],'Г':['гора','Berg'],'Ґ':['ґанок','Vorbau'],'Д':['дім','Haus'],'Е':['екран','Bildschirm'],'Є':['єнот','Waschbär'],'Ж':['жук','Käfer'],'З':['зуб','Zahn'],'И':['син','Sohn'],'І':['ім’я','Name'],'Ї':['їжа','Essen'],'Й':['йогурт','Joghurt'],'К':['кіт','Katze'],'Л':['лампа','Lampe'],'М':['мама','Mama'],'Н':['ніс','Nase'],'О':['око','Auge'],'П':['парк','Park'],'Р':['рука','Hand'],'С':['сир','Käse'],'Т':['так','Ja'],'У':['урок','Lektion'],'Ф':['фото','Foto'],'Х':['хата','Haus'],'Ц':['це','das / dies'],'Ч':['чай','Tee'],'Ш':['школа','Schule'],'Щ':['щука','Hecht'],'Ь':['кінь','Pferd'],'Ю':['юнак','junger Mann'],'Я':['яблуко','Apfel']
  };
