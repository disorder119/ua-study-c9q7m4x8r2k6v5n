...
(() => {
  ...
  const LESSONS=[
    ...
    ['Können, wissen, verstehen','Vier starke Ich-Sätze plus ein Bedürfnis.','Diese Formen sind sofort verwendbar. Die Wörterbuchform kommt später; zuerst zählt, was du sagen kannst.',[['Я можу…','Ich kann …','ja mo-schu'],['Я знаю…','Ich weiß / kenne …','ja sna-ju'],['Я розумію…','Ich verstehe …','ja ro-su-mi-ju'],['Я люблю…','Ich mag / liebe …','ja lju-blju'],['Мені треба…','Ich brauche / muss …','me-ni tre-ba']]],
    ['Verneinen ohne Umweg','Setze не direkt vor das, was du verneinst.','Lerne ganze negative Chunks. So musst du in einem echten Gespräch nicht erst eine Grammatikregel zusammensetzen.',[['Я не хочу…','Ich möchte / will nicht …','ja ne cho-tschu'],['Я не можу…','Ich kann nicht …','ja ne mo-schu'],['Я не знаю','Ich weiß nicht','ja ne sna-ju'],['Я не розумію','Ich verstehe nicht','ja ne ro-su-mi-ju'],['У мене немає…','Ich habe kein / keine …','u me-ne ne-ma-je']]],
    ['Direkt nachfragen','Jetzt kommen häufige Du-Fragen.','Achte auf die Endungen. Du musst sie nicht theoretisch benennen, sondern als Frage-Muster abrufen.',[['Ти хочеш…?','Möchtest / willst du …?','ty cho-tschesch'],['Ти можеш…?','Kannst du …?','ty mo-schessch'],['Ти знаєш…?','Weißt / kennst du …?','ty sna-jesch'],['Ти розумієш?','Verstehst du?','ty ro-su-mi-jesch'],['Де ти живеш?','Wo wohnst du?','de ty schy-wesch']]],
    ['Zahlen 11 bis 15','Die nächste Zahlengruppe.','Höre auf den gemeinsamen Rhythmus und rufe die Zahlen auch durcheinander ab.',[['одинадцять','elf','o-dy-nad-zjat'],['дванадцять','zwölf','dwa-nad-zjat'],['тринадцять','dreizehn','try-nad-zjat'],['чотирнадцять','vierzehn','tscho-tyr-nad-zjat'],['п’ятнадцять','fünfzehn','pjat-nad-zjat']]],
    ['Zahlen 16 bis 20','Bis zwanzig ohne Übersetzungskette.','Mische diese Zahlen später mit 1–15; reines Aufsagen in Reihenfolge reicht nicht.',[['шістнадцять','sechzehn','schist-nad-zjat'],['сімнадцять','siebzehn','sim-nad-zjat'],['вісімнадцять','achtzehn','wi-sim-nad-zjat'],['дев’ятнадцять','neunzehn','de-wjat-nad-zjat'],['двадцять','zwanzig','dwa-zjat']]],
    ['Essen als echtes Bedürfnis','Nicht nur Lebensmittel benennen, sondern Bedürfnisse ausdrücken.','Diese Chunks funktionieren in vielen Situationen und werden später mit konkreten Speisen kombiniert.',[['сніданок','Frühstück','sni-da-nok'],['обід','Mittagessen','o-bid'],['вечеря','Abendessen','we-tsche-rja'],['Я хочу їсти','Ich möchte essen / Ich habe Hunger','ja cho-tschu ji-sty'],['Я хочу пити','Ich möchte trinken / Ich habe Durst','ja cho-tschu py-ty']]],
    ['Wichtige Orte','Fünf Orte, die du unterwegs wirklich brauchst.','Verbinde sie sofort mit Де …? aus dem bisherigen Kurs.',[['магазин','Geschäft','ma-ha-syn'],['супермаркет','Supermarkt','su-per-mar-ket'],['ресторан','Restaurant','res-to-ran'],['туалет','Toilette','tu-a-let'],['банк','Bank','bank']]],
