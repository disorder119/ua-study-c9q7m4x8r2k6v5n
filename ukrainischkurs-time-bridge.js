/* Ukrainischkurs für Joel · Time Bridge v1
   Kleine A1-Brücke für Zeitbezug: gestern/heute/morgen, einfache Vergangenheit
   und analytische Zukunft mit буду + Infinitiv. Keine Aspekt-Tabelle; Fokus Produktion. */
(()=>{
  const VERSION=1;
  ...
  rule(1,'був / була','Produziere die passende Vergangenheitsform.',[
    {q:'Ich war im Hotel. (als Mann)',a:['Я був у готелі','Я був в готелі']},
    {q:'Ich war im Hotel. (als Frau)',a:['Я була у готелі','Я була в готелі']},
    {q:'Sie war zu Hause.',a:['Вона була вдома','Вона була удома']}
  ]);
  rule(2,'Vergangenheit aktiv','Bilde häufige eigene Aussagen.',[
    {q:'Gestern habe ich gearbeitet. (als Mann)',a:['Вчора я працював','Учора я працював']},
    {q:'Ich wollte … (als Mann)',a:['Я хотів…','Я хотів']},
    {q:'Ich sprach … (als Frau)',a:['Я говорила…','Я говорила']}
  ]);
  rule(3,'Я буду + Infinitiv','Bilde Zukunft ohne Antwortauswahl.',[
    {q:'Ich werde arbeiten.',a:['Я буду працювати']},
    {q:'Ich werde sprechen.',a:['Я буду говорити']},
    {q:'Ich werde in Kyjiw wohnen.',a:['Я буду жити в Києві','Я буду жити у Києві']}
  ]);
  rule(4,'будеш / буде','Wechsle die Person in der Zukunft.',[
    {q:'Wirst du arbeiten?',a:['Ти будеш працювати?']},
    {q:'Er wird arbeiten.',a:['Він буде працювати']},
    {q:'Sie wird in Kyjiw wohnen.',a:['Вона буде жити в Києві','Вона буде жити у Києві']}
  ]);
  rule(5,'Gemischter Zeit-Transfer','Die Aufgabe nennt die Zeit nicht als Grammatiklabel.',[
    {q:'Morgen werde ich arbeiten.',a:['Завтра я буду працювати','Я буду працювати завтра']},
    {q:'Gestern war ich im Hotel. (als Mann)',a:['Вчора я був у готелі','Учора я був у готелі','Вчора я був в готелі','Учора я був в готелі']},
    {q:'Sie war zu Hause.',a:['Вона була вдома','Вона була удома']},
    {q:'Wirst du sprechen?',a:['Ти будеш говорити?']},
    {q:'Heute bin ich zu Hause.',a:['Сьогодні я вдома','Я сьогодні вдома']}
  ]);
